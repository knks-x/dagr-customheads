...
if __name__ == '__main__':
    ...
    output_directory = set_up_logging_directory(args.dataset, args.task,  args.output_directory, exp_name)

    log_hparams(args)

    print("init datasets")
    test_dataset = DSEC(root=args.dataset_directory, sync=args.sync, transform=Augmentations.transform_testing, sync=args.sync,
